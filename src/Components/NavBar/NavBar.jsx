...
const NavBar = () => {
  ...
  return (
    <div className='navbar flex items-center justify-between my-5 mx-5 xl:mx-[170px] md:mx-[30px] max-md:my-[20px]  lg:mx-[80px]'>
      ...
      <ul ref={menuRef} className='flex items-center list-none gap-[60px] text-[17px] max-md:fixed max-md:flex-col max-md:items-start max-md:top-0 max-md:gap-[30px] max-md:bg-[#1F0016] max-md:w-[350px] max-md:h-full max-md:z-[2] max-md:transition-[right] max-md:duration-[0.5s] max-md:right-[-350px] '>
        ...
        <li className='max-md:text-[30px] max-md:pl-[100px] max-md:flex-row max-md:gap-[20px] '><AnchorLink href='#home' onClick={closeMenu}>Home</AnchorLink></li>
        <li className='max-md:text-[30px] max-md:pl-[100px] max-md:flex-row max-md:gap-[20px] '><AnchorLink offset={20} href='#about' onClick={closeMenu}>About Me</AnchorLink></li>
        <li className='max-md:text-[30px] max-md:pl-[100px] max-md:flex-row max-md:gap-[20px] '><AnchorLink offset={50} href='#work' onClick={closeMenu}>Projects</AnchorLink></li>
        <li className='max-md:text-[30px] max-md:pl-[100px] max-md:flex-row max-md:gap-[20px] '><AnchorLink offset={20} href='#offers' onClick={closeMenu}>Services</AnchorLink></li>
      </ul>
